...
// //   // Embeddable Google Drive video URL
// //   const demoVideoUrl = 'https://drive.google.com/file/d/1hMsxltxEBM4Zk1CoSe8lmBv6a36rv-mf/preview';
...
// //               <button
// //                 onClick={openModal}
// //                 className="inline-flex items-center justify-center px-6 py-3 text-sm font-medium text-white bg-white/10 hover:bg-white/20 rounded-xl backdrop-blur-sm transition-all duration-300"
// //               >
// //                 Watch Demo
// //               </button>
// //             </div>
...
// //                     <button
// //                       type="button"
// //                       className="inline-flex justify-center rounded-md border border-transparent bg-[#5B3557] px-4 py-2 text-sm font-medium text-white hover:bg-[#4a2a46] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#5B3557]"
// //                       onClick={closeModal}
// //                     >
// //                       Close
// //                     </button>
...
//           {/* Feature Card - Lowered with margin-top */}
//           <Card className="bg-white text-[#1A1A1A] shadow-lg rounded-2xl border border-gray-300 overflow-hidden mt-8">
//             <CardContent className="p-6 space-y-6">
//               <h3 className="text-xl font-semibold">Why Choose Pacx.ai?</h3>
//               <ul className="space-y-5">
//                 <li className="flex items-start group">
...
//       {/* Modal for Video - Increased Size */}
//       <Transition appear show={isModalOpen} as={React.Fragment}>
//         <Dialog as="div" className="relative z-50" onClose={closeModal}>
//           <Transition.Child
//             as={React.Fragment}
...
const PacxLanding6 = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-white">
      ...
      {/* Modal for Video - Optimized for Clarity */}
      <Transition appear show={isModalOpen} as={React.Fragment}>
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          <Transition.Child
            as={React.Fragment}
              ...
              >
                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4">
                    <iframe
                      src={demoVideoUrl}
                      className="w-full h-[576px] rounded-lg aspect-video"
                      allow="autoplay"
                      allowFullScreen
                      title="Demo Video"
                    />
