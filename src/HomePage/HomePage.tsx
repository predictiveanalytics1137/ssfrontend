...
const Homepage = () => {
  ...
  useEffect(() => {
    const fetchNotebooks = async () => {
      setLoading(true);
      try {
        const url = `${API_BASE_URL}/api/notebooks/?user_id=${HARDCODED_USER_ID}`;
        ...
        //     ${API_BASE_URL}/api/get_prediction_metadata/?user_id=xxx&chat_id=yyy
        ...
        for (const nb of rawNotebooks) {
          ...
          try {
            const metaUrl = `${API_BASE_URL}/api/get_prediction_metadata/?user_id=${user_id_str}&chat_id=${chat_id}`;
            console.log(metaUrl);
            console.log(" this is meta url....................");
            // const metaUrl = "${API_BASE_URL}/api/get_prediction_metadata/?user_id=9&chat_id=cc2ea5cc-0805-4c2d-b79b-47b4751c03d1"
